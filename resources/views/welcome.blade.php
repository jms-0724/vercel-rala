...
<body class="w3-black">
  ...
  <nav class="w3-sidebar w3-bar-block w3-small w3-hide-small w3-center">
    ...
    <img
      src="https://scontent.fmnl9-3.fna.fbcdn.net/v/t39.30808-6/425805279_24786320157678903_4165667758066397322_n.jpg?_nc_cat=102&ccb=1-7&_nc_sid=5f2048&_nc_eui2=AeFeEDlwZ2Rw9Tia-a5YxWOzfF1MbE1vALp8XUxsTW8Aulp4NjMzyycYmD9nnUYfcbIXbFZsETYwlRsXEb6UoCe7&_nc_ohc=OXumOMwRRNYQ7kNvgHGPoYG&_nc_ht=scontent.fmnl9-3.fna&oh=00_AYDbtkjbMsaGj3CmKcE59tnno-ak0AnX73i7fXmmy_csjQ&oe=664A091B"
      style="width:100%">
  ...
  <div class="w3-padding-large" id="main">
    ...
    <header class="w3-container w3-padding-32 w3-center w3-black" id="home">
      <h1 class="w3-jumbo"><span class="w3-hide-small">I'm</span> Julius Z. Rala</h1>
      <p>A Web Designer.</p>
      <img
        src="https://scontent.fmnl9-3.fna.fbcdn.net/v/t39.30808-6/425805279_24786320157678903_4165667758066397322_n.jpg?_nc_cat=102&ccb=1-7&_nc_sid=5f2048&_nc_eui2=AeFeEDlwZ2Rw9Tia-a5YxWOzfF1MbE1vALp8XUxsTW8Aulp4NjMzyycYmD9nnUYfcbIXbFZsETYwlRsXEb6UoCe7&_nc_ohc=OXumOMwRRNYQ7kNvgHGPoYG&_nc_ht=scontent.fmnl9-3.fna&oh=00_AYDbtkjbMsaGj3CmKcE59tnno-ak0AnX73i7fXmmy_csjQ&oe=664A091B"
    ...
    <div class="w3-content w3-justify w3-text-grey w3-padding-64" id="about">
      ...
      <p>
        Julius Z. Rala. A Bachelor of Science in Information Technology student. I am currently studying at the Saint
        Louis College. Located at City of San Fernando, La Union.
      </p>
      ...
      <div class="w3-padding-64 w3-content w3-text-grey" id="contact">
        ...
        <div class="w3-section">
          <p><i class="fa fa-map-marker fa-fw w3-text-white w3-xxlarge w3-margin-right"></i> Lingsat, SFC, La Union</p>
          <p><i class="fa fa-phone fa-fw w3-text-white w3-xxlarge w3-margin-right"></i> Phone: +63 9615040885</p>
          <p><i class="fa fa-envelope fa-fw w3-text-white w3-xxlarge w3-margin-right"> </i> Email:
            ceejhayralz28@gmail.com</p>
        </div><br>
